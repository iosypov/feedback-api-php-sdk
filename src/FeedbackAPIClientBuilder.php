...
class FeedbackAPIClientBuilder
{
    /**
     * @var array
     */
    ...
    public function xRapidAPIKey(string $xRapidAPIKey): self
    {
        $this->config['xRapidAPIKey'] = $xRapidAPIKey;
        return $this;
    }
    ...
    public function build(): FeedbackAPIClient
    {
        return new FeedbackAPIClient($this->config);
    }
}
